...
| **Requirements** | Functional and verification rules. | [FR_UNIQUE (Unique IDs)](./requirements/functional/verification.md#FR_UNIQUE), [FR_CLAUDE_PLUGIN (Functional Requirements: Claude Plugin)](./requirements/functional/claude-plugin.md#FR_CLAUDE_PLUGIN), [NFR_PERF (High Performance)](./requirements/non-functional/performance.md#NFR_PERF), [NFR_EXT (Modular Design)](./requirements/non-functional/extensibility.md#NFR_EXT) |
