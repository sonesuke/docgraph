...
- [CC_SINGLE_RESPONSIBILITY (Single Responsibility Principle (SRP))](../architecture/design/single-responsibility.md#CC_SINGLE_RESPONSIBILITY) Promotes modularity
- [CC_THIN_HANDLERS (Thin Handlers Pattern)](../architecture/design/thin-handlers.md#CC_THIN_HANDLERS) Simplifies extension points
- [CC_ERROR_HANDLING (Error Handling Strategy)](../architecture/design/error-handling.md#CC_ERROR_HANDLING) Isolates error handling
