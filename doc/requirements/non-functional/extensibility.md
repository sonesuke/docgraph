...
- [CC_THIN_HANDLERS (Thin Handlers)](../../architecture/design/thin-handlers.md#CC_THIN_HANDLERS)
- [CC_ERROR_HANDLING (Error Handling Boundaries)](../../architecture/design/error-handling.md#CC_ERROR_HANDLING)
